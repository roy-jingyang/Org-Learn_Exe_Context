...
if __name__ == '__main__':
    ...
    # Load data
    log = read_csv('./input/sepsis.preprocessed.csv')
    ...
    # TODO: include numeric attributes
    ...
    if MODE == 'learn':
        miner = ODTMiner(log, spec, max_height=MAX_HEIGHT, trace_history=True, use_ohe=False)
    else:
    ...
    if MODE == 'learn':
        ...
        fn_miner = 'ODTMiner-sepsis_h{}_{}.miner'.format(
            MAX_HEIGHT, 
    ...
    om, fit, prec = disc_eval_om(rl, n_groups=list(range(2, 25+1)))
