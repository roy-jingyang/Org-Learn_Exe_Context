...
def disc_eval_om(rl, ct=None, at=None, tt=None, n_groups=2):
    ...
    #rgs = moc(profiles, n_groups=n_groups)
    #om = full_recall(rgs, rl)
...
if __name__ == '__main__':
    ...
    # Load data
    log = read_csv('./input/wabo.preprocessed.csv')
    ...
    cases_rm = set()
    SEL_ATTRS = [
        'case:channel', 'case:department', 'case:responsible',
        'case:days_remained'
    ]
    ...
    if MODE == 'learn':
        ...
        fn_miner = 'ODTMiner-wabo_h{}_{}.miner'.format(
            MAX_HEIGHT, 
    ...
    om, fit, prec = disc_eval_om(rl, n_groups=list(range(2, 10+1)))
